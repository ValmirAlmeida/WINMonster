...
/**
 *  Exceção lançada durante a descompactação de uma entidade cujo texto foi violado.
 * 
...
public class IntegridadeVioladaException extends Exception {
    ...
    */
    public IntegridadeVioladaException() {
        super("Erro ao realizar descompactação, a integridade foi violada.");
    }
	...
	super("Erro ao realizar descompactação, a integridade foi violada.", causa);
    }
